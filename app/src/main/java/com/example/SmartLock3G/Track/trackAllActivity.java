...
import com.example.SmartLock3G.model.ItemInfo;
...
public class trackAllActivity extends BaseActivity {
    ...
    private void init() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View v, int index, long arg3) {
                Intent intent = new Intent(trackAllActivity.this, trackApp.itemInfos.get(index).clazz);
    ...
    public class MyAdapter extends BaseAdapter
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (null != convertView) {
                ...
                convertView = View.inflate(trackAllActivity.this, R.layout.item_list, null);
